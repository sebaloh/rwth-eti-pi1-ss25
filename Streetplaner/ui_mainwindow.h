...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(pushButton_testMap, 8, 0, 1, 1);
        ...
        gridLayout->addWidget(pushButton_testCity, 7, 0, 1, 1);
