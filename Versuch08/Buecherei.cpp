...
int main()
{
    ...
    do  // Anzeige des Men�s
    {
        std::cout << std::endl
				  ...
				  << "(6): Ausgeliehende Medien" << std::endl
                  << "(7): Beenden" << std::endl;
        ...
        switch (abfrage)
        {
            ...
            ///////////////////////////////////////
			// Liste aller ausgeliehenden Medien //
			///////////////////////////////////////
			case '6':
			{
...
void ausgeliehendeMedienAusgeben(std::vector<Medium*>& medien)
{
    std::cout << "Ausgeliehenden Medien in der B�cherei:" << std::endl;
	...
	{
		std::cout << "*************************************************************" << std::endl;
		std::cout << "Es sind mometan keine Medien ausgeliehen." << std::endl;
	}
}
